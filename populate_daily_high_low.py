...
def main():
    ...
    print("=" * 60)
    print("Trading Instrument: MES (Micro E-mini S&P 500)")
    print(f"Data Source: {args.ticker} via Yahoo Finance")
    print("Note: MES and ES track the same index with identical price levels")
    print("      Only difference is contract size ($5/point vs $50/point)")
    print("=" * 60)
    print()
