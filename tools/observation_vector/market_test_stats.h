...
// tools/observation_vector/drift_location_stats.h on its second real use (tools/observation_vector/jump_ratio_eval.cpp).
...
// use (ComputeBootstrapMedianGapCI and tools/observation_vector/jump_ratio_eval.cpp's own
...
// Mirrors tools/observation_vector/dim_acceptance_eval.py's compute_forward_returns() semantics
...
// Mirrors tools/observation_vector/dim_acceptance_eval.py's wilson_ci() exactly (lines 171-178).
...
// Mirrors tools/observation_vector/dim_acceptance_eval.py's predictive_power_directional() hit-rate
