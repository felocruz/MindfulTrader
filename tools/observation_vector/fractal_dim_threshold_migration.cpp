...
// tools/observation_vector/hill_intraday_seasonality.cpp.
//
// Build: g++ -O2 -std=c++17 -Iinclude tools/observation_vector/fractal_dim_threshold_migration.cpp -o fractal_dim_threshold_migration
