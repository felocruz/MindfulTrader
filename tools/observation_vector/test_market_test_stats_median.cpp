// tools/observation_vector/test_market_test_stats_median.cpp
// Build & run: mamba run -n mts g++ -std=c++17 tools/observation_vector/test_market_test_stats_median.cpp \
