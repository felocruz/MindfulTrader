// tools/burstiness_recalibration.cpp
...
// Same reporting shape as tools/amihud_liqfragility_recalibration.cpp's
...
int main(int argc, char** argv) {
    ...
    for (const std::int64_t ts : series.timestamp_us) {
        ...
        // tools/amihud_liqfragility_recalibration.cpp for dims 12/13.
