...
from dash_util import (
    APP_CARD_BACKGROUND_COLOR,
    APP_INPUT_BACKGROUND_COLOR,
    APP_LIGHT_COLOR,
    card_header,
)
                    ...
                    [
                        ...
                        dbc.Row(
                            [
                                dbc.Col(
                                    [
                                        dbc.Label(children="Current Symbol", color="orange"),
                                        dbc.Input(
                                            id="config_current_symbol",
                                            value="FXAIX",
                                            type="text",
                                            style={
                                                "backgroundColor": APP_INPUT_BACKGROUND_COLOR,
                                ...
                                dbc.Col(
                                    [
                                        dbc.Label(children="IB Symbol", color="orange"),
                                        dbc.Input(
                                            id="config_ib_symbol",
                                            value="ES-202112-GLOBEX",
                                            type="text",
                                            style={
                                                "backgroundColor": APP_INPUT_BACKGROUND_COLOR,
                                                "color": APP_LIGHT_COLOR,
