...
`docs/superpowers/specs/2026-09-18-predator-sniper-execution-architecture.md` §2/§3/§3a
...
- **Organized into subfolders by function** (reorg 2026-09-02): `tools/observation_vector/`
  ...
  `#include "x.h"` resolves relative to the including file's own directory, so same-group
  cross-includes need no path prefix. **Full per-file index and grouping (incl. an
  `observation_vector/` Evals/Recalibration/Diagnostics/Shared-headers/Tests breakdown):
  `tools/README.md`.**
