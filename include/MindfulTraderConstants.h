...
namespace PersistentVar_AdaptiveCalculators {
    ...
    const int LOG_SCALE_EXPANSION_RATIO_LAST_VALID_VALUE = 32; // Last valid log_scale_expansion_ratio for graceful degradation on a near-zero full-window variance rate
